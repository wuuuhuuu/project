...
For our final project,We will use UFO Sightings Dataset,which was collected by NATIONAL UFO REPORTING CENTER    (NUFORC).It contains 80333 records of reported UFO Sightings from 1906-2014.
...
3.How long has the UFO been around on average?
...
```
We find UFOs have 30 different shapes,they also contain unknown shapes,so maybe there are more shapes.
The most common shape is light,it is much more than the next triangle,that means if UFOs are real,it's probably have light shape and it's consistent with people's impression of UFOs. 
